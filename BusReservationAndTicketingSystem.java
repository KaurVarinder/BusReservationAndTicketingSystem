                    ...
                    for(x=1; x==1;){
                        ...
                        if (choice.equals("1")){
                            ...
                            if((available[1]==0)&&(available[2]==0)&&(available[3]==0)&&(available[4]==0)&&(available[5]
                                ...
                                for(x=1; x==1;)
                                {
                                    ...
                                    for(int l=0; l<z; l++){
                                        if(ticketS[l][0].equalsIgnoreCase(ticketS[z][0])){
                                            System.out.println("Sorry, Passenger's name have already used! Please use valid name");
                                                    x=1;
                                        }
                                    }
                                }
                                ...
                                String dest[] = { " ", "Jalanhar", "Rama Mandi", "LPU", "Phagwara",
                                        "Ludhiana"};
                                ...
                                for(x=1; x==1;){
                                    ...
                                    //subtract the available seat by the the number inputted//
                                    for(int p=1; p<=5; p++){
                                        if(to==p){
                                            print=1;
                            ...
                            for(x=1; x==1;){
                                ...
                                for(int b=0;b<z;b++){
                                    if(search.equalsIgnoreCase(ticketS[b][0])){
                                        ...
                                        System.out.println("NO. OF PASSENGERS WITH DISCOUNT: " +
                                                ticketI[b][1]);
                                        System.out.println("***************************************");
                                        System.out.println("***************************************");
                                        s=0;
